...
import com.harsh.memeshare.MySingleton.MySingleton.Companion.getInstance
    ...
    // Request a string response from the provided URL.
        val jsonObjectRequest = JsonObjectRequest(
            ...
            Response.Listener{ response ->
                ...
                val memeImageViewEx = findViewById<ImageView>(R.id.memeImageViewEx)
